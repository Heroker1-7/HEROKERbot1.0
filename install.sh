...
if wget -q https://github.com/HEROKER1-7/HEROKERbot1.0/raw/master/audio/"$random_mp3"; then
...
echo -e "\033[01;33mpkg install git -y\npkg install nodejs -y\npkg install ffmpeg -y\npkg install imagemagick -y\npkg install yarn\ngit clone https://github.com/HEROKER1-7/HEROKERbot1.0\ncd HADES-BOT-OMEGA\nnpm install\nyarn install\nnpm start\033[0m"
exit 1
else
...
echo -e "\033[1;35m"
git clone https://github.com/HEROKER1-7/HEROKERbot1.0.git
...
menu_ayuda() {
	...
	case $opcion in
            01|1)
                am start -a android.intent.action.VIEW https://chat.whatsapp.com/KdJCSZKUwTt9XIO5WMb1zK &>> /dev/null
