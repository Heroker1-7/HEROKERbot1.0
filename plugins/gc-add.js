...
let teks = `[?] No fue posible agregar @${jid.split('@')[0]}, esto puede suceder porque el número es incorrecto, la persona abandonó recientemente el grupo o la persona ha configurado su privacidad en los grupos. la invitación al grupo en su privacidad ha sido enviada al usuario*`
m.reply(teks, null, { mentions: conn.parseMention(teks)})
let captionn = `¡¡Ey!! Hola, me presento, soy HEROKER bot-MD, y soy un Bot para Whatsapp, un grupo del grupo usa el comando para agregar al grupo, pero no pude agregarte, así que te enviaré la invitación para que te agregues, te esperamos!!`    
