...
export async function before(m, { conn, isAdmin, isBotAdmin, usedPrefix }) {
  ...
  let fakemek = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "5215522416844@g.us","inviteCode": "m","groupName": "P", "caption": '乂✰𝙃𝙀𝙍𝙊𝙆𝙀𝙍 𝙗𝙤𝙩-ᴍᴅ✰乂', 'jpegThumbnail': null}}}
