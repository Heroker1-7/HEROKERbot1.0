...
if (Object.values(conn.game).find(room => room.id.startsWith('tictactoe') && [room.game.playerX, room.game.playerO].includes(m.sender))) throw `*[❗] Todavía estás en un juego con alguien.*`
if (!text) throw `*[❗] Requerido nombrar la sala de juegos.*\n\n*—◉ Ejemplo*\n*◉ ${usedPrefix + command} Nueva sala*`
